...
function drawit(num1) {
  ...
  // console.log(num)
  d3.csv(
    "https://raw.githubusercontent.com/Dave870907/d3.js-practice/master/news2.csv",
    function (data) {
      var data = data[num];
...
$(document).ready(function () {
  d3.csv(
    "https://raw.githubusercontent.com/Dave870907/d3.js-practice/master/news.csv",
    function (data) {
      console.log(data);
      ...
      var width = 535 - margin.left - margin.right,
      ...
      var dataset = d3.layout.stack()(
        ["Wind", "Water", "Sun", "Trash"].map(function (power) {
